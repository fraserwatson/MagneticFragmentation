...
def write_props(props, polarity, image_num, image_date, submap, act_region, thres, main):
    ...
    propspath= main + act_region + '_' + str(thres) + 'G_fragment_properties_v2digits/'
    bulk_path = main + 'bulk_props_'+ act_region +  '_' + str(thres) +'G_v2digits.txt'
    ...
    # Check to see if the area of the fragment is 12 pixels or larger
        ...
        # lat is position {1} in the write command
        # lng is position {2} in the write command
        ...
        # position {3} in the write command
        ...
        # Record the position of the fragment pixel that was calculated above, to be used when plotting
        # label maps.
        #position {25} in the write command
